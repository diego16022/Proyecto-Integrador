    ...
    return Center(
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              const Text('Agregar Nueva Prenda',
                  ...
                  _botonRedondo(
                    ...
                    onTap: () async {
                      try {
                        ...
                        // Paso 1: crear la prenda
                        final idPrenda = await PrendaService.crearPrenda(
                          nombre: _nombre!,
                          tipo: _tipo!.name,
                        ...
                        // Paso 2: asociar con ocasión
                        if (_idOcasionSeleccionada != null) {
                          await PrendaService.asociarOcasion(idPrenda, _idOcasionSeleccionada!);
                        }
